...
import jp.kuroda.jobNavi.service.CompanyService;
...
public class CompanyControllerTest {
	...
	public void testIndexHasPermissoion() throws Exception{
		mockMvc.perform(get("/company"))
	...
	@Test
	@WithMockUser(roles="COMPANY")
	public void testEditOfferGetNotHasPermission() throws Exception{
	...
	@Test
	@WithMockUser(roles="COMPANY")
	public void testShowEntryNotPermission() throws Exception{
